;; file: load-keyboard.el
;; change default keyboard shortcut settings
;; {{{ for system keyboard
...
;; }}}
;; {{{ for orgmode keyboard
(global-set-key (kbd "C-c omst" 'org-match-sparse-tree))
(global-set-key (kbd "C-c omtv" 'org-tags-view))
